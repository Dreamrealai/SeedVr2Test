#!/bin/bash
# Install SeedVR2 on RunPod Pod

set -e

POD_ID="lh0wm9g482zr28"

echo "=== Installing SeedVR2 on RunPod Pod ==="
echo "Pod ID: $POD_ID"
echo

# First, create the installation script
cat > setup_seedvr2.py << 'EOF'
#!/usr/bin/env python3
import os
import subprocess
import sys
...
echo "Sending setup script to RunPod pod..."
runpodctl send setup_seedvr2.py --code seedvr2setup

echo
echo "Now you need to:"
echo "1. Go to https://www.runpod.io/console/pods"
echo "2. Click on your pod 'SeedVr2Test'"
echo "3. Open the terminal"
echo "4. Run: python /workspace/setup_seedvr2.py"
echo "5. Start the API: /workspace/start_api.sh"
echo
echo "Once the API is running, we'll update your frontend to use it!"